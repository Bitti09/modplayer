...
ChiptuneJsPlayer.prototype.setLoop = function (loop) {
  return libopenmpt._openmpt_module_set_repeat_count(this.currentPlayingNode.modulePtr, loop);
}
ChiptuneJsPlayer.prototype.getLoop = function (loop) {
